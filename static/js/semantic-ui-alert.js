...
$.uiAlert = function(options) {
  var setUI = $.extend({
    ...
    var message = $('<div id="messages" class="ui icon message" ' + setUI.bgcolors + '><i class="'+setUI.icon+' icon" style="color: '+setUI.textcolor+';"></i><i class="close icon" style="color: '+setUI.textcolor+';" id="messageclose"></i><div style="margin-right: 10px;">   <div class="header" style="color: '+setUI.textheadcolor+';font-weight: bold;">'+setUI.textHead+'</div> <p style="color:'+setUI.textcolor+';">'+setUI.text+'</p></div>  </div>');
